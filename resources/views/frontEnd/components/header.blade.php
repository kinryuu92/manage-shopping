            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{route('home.index')}}"><img src="https://sanhruou.com/media/1645/content/sanh-ruou.png" alt=""/></a>
                    </div>
                </div>
                <div class="col-sm-8">
...
{{--                                <img src="{{ Illuminate\Support\Facades\Auth::cusotmer()->avatar }}" alt="{{ Illuminate\Support\Facades\Auth::cusotmer()->name }}"--}}
